...
<div class="min-h-screen bg-gray-950 py-12">
    <div class="container mx-auto px-4 max-w-3xl">
        ...
        <div class="bg-gray-950 rounded-xl shadow-lg p-8 mb-8">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    <p class="text-sm text-gray-300">{{ __('Unit Price') }}</p>
            ...
            <form method="POST" action="{{ route('payment-proof.update', $booking) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-300 mb-1">{{ __('Upload a clear screenshot of the transfer') }}</p>
                ...
                <button type="submit" class="w-full bg-red-500 hover:bg-red-600 text-white font-bold text-xl py-4 px-6 rounded-xl shadow-lg shadow-red-500/30 hover:shadow-red-500/40 transition">{{ __('Resubmit Proof') }}</button>
            </form>
        </div>
