...
<div class="min-h-screen bg-gray-950 py-12">
    <div class="container mx-auto px-4 max-w-2xl">
        <div class="bg-gray-950 rounded-xl shadow-lg p-8 text-center">
            ...
            @if ($service->isConfigured())
                ...
                <div class="bg-gray-950 rounded-lg p-4 mt-6">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('booking.show', $booking->reference) }}" class="text-gray-400 hover:text-red-500">{{ __('← Back to Booking') }}</a>
            </div>
        </div>
    </div>
</div>
